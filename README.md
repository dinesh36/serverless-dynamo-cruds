# serverless-dynamo-cruds
Sample application for simple crud operation APIs with dynamo DB and serverless

### Here are some helper links to get started with project

- [AWS credentials setup with serverless](https://www.youtube.com/watch?v=D5_FHbdsjRc)
